...
router.get('/grafico-doce-meses', auth.verifyUsuario, ventaController.graficoDoceMeses)

router.get('/consulta-rango-fechas', auth.verifyUsuario, ventaController.consultaFechas)
/*
