...
router.get('/list-clientes', auth.verifyUsuario, personaController.listClientes)

router.get('/list-proveedores', auth.verifyUsuario, personaController.listProveedores)
